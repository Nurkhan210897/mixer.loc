    ...
    >
      <template v-slot:top>
        <v-toolbar flat color="white">
          <v-toolbar-title>Стили</v-toolbar-title>
...
export default {
  ...
  methods: {
    ...
    store() {
      axios
        .post("/api/filter/styles", this.editedItem)
        .then((response) => {
          var res = response.data;
          if (res.success) {
    ...
    update() {
      axios
        .put("/api/filter/styles/" + this.editedItem.id, this.editedItem)
        .then((response) => {
          var res = response.data;
          if (res.success) {
    ...
    deleteItem() {
      axios
        .delete("/api/filter/styles/" + this.editedItem.id)
        .then((response) => {
          var res = response.data;
          if (res.success) {
