    ...
    >
      <template v-slot:top>
        <v-toolbar flat color="white">
          <v-toolbar-title>Цвета</v-toolbar-title>
...
export default {
  ...
  methods: {
    ...
    store() {
      axios
        .post("/api/filter/colors", this.editedItem)
        .then((response) => {
          var res = response.data;
          if (res.success) {
    ...
    update() {
      axios
        .put("/api/filter/colors/" + this.editedItem.id, this.editedItem)
        .then((response) => {
          var res = response.data;
          if (res.success) {
    ...
    deleteItem() {
      axios
        .delete("/api/filter/colors/" + this.editedItem.id)
        .then((response) => {
          var res = response.data;
          if (res.success) {
